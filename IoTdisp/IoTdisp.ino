...
void graphdisp(int mm)
{
    ...
    if(mm == 0){
        ...
        display.fillRect(0, 680, 1280, 40, DARKGREY);
        display.setFont(&fonts::lgfxJapanGothic_40);
        display.setTextSize(1);
        display.setTextColor(CYAN, DARKGREY);
        display.setCursor(temppos[0], temppos[1]);
...
//          Serial.println(text);
            if(text.length() != 17){
                ...
                if(text.startsWith(header[0]))      num = 0;
                else if(text.startsWith(header[1])) num = 1;
                else if(text.startsWith(header[2])) num = 2;
                else if(text.startsWith(header[3])) num = 3;
                else if(text.startsWith(header[4])) num = 4;
